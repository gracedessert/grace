...
const STANZAS: string[][] = [
  ...
  [
    ...
    "faster, tuck my hair, turn a corner, and startle myself with a smile and",
  ...
  [
    ...
    "and i'm left to continue my self-help books, regretted words",
  ],
  [
    "the air is crisp and i will myself to appreciate the view.",
  ...
  [
    ...
    "wonder again if it's dangerous to cry.",
    ".",
    "but i can breathe",
